...
namespace SmartRead.MVVM.ViewModels
{
    public partial class NewsViewModel : ObservableObject
    {
        ...
        {
            new LibroNoticia { Imagen = "image2.png", Titulo = "Don Quijote de la Mancha", Descripcion = "La historia de un caballero que sueña con ser héroe y sus increibles aventuras en un mundo que ya no cree en la caballeria" },
            new LibroNoticia { Imagen = "cien_anos.png", Titulo = "Cien años de soledad", Descripcion = "La saga de la familia Buendía en Macondo, un realismo mágico..." },
            new LibroNoticia { Imagen = "el_principito.png", Titulo = "El Principito", Descripcion = "Un niño que viaja por planetas aprendiendo lecciones de vida..." }
        };

        private readonly ObservableCollection<LibroNoticia> NovedadesEditoriales = new()
        {
            new LibroNoticia { Imagen = "1984.jpg", Titulo = "1984", Descripcion = "Una sociedad controlada por el Gran Hermano..." },
            new LibroNoticia { Imagen = "fahrenheit.jpg", Titulo = "Fahrenheit 451", Descripcion = "Una sociedad donde los libros están prohibidos..." },
            new LibroNoticia { Imagen = "brave_new_world.jpg", Titulo = "Un Mundo Feliz", Descripcion = "Una distopía sobre el control social..." }
        };
